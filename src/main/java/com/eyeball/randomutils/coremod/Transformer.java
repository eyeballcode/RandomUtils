...
public class Transformer implements Opcodes {
    ...
    public static byte[] transformEnderPearl(byte[] classBytes) {
        ...
        MethodVisitor visitor = classNode.visitMethod(ACC_PUBLIC, "onItemRightClick", "(Lnet/minecraft/item/ItemStack;Lnet/minecraft/world/World;Lnet/minecraft/entity/player/EntityPlayer;)Lnet/minecraft/item/ItemStack;", null, null);

        visitor.visitCode();
        Label l0 = new Label();
        visitor.visitLabel(l0);
        visitor.visitLineNumber(12, l0);
        visitor.visitVarInsn(ALOAD, 1);
        visitor.visitInsn(DUP);
        visitor.visitFieldInsn(GETFIELD, "net/minecraft/item/ItemStack", "stackSize", "I");
        visitor.visitInsn(ICONST_1);
        visitor.visitInsn(ISUB);
        visitor.visitFieldInsn(PUTFIELD, "net/minecraft/item/ItemStack", "stackSize", "I");
        Label l1 = new Label();
        visitor.visitLabel(l1);
        visitor.visitLineNumber(13, l1);
        visitor.visitVarInsn(ALOAD, 2);
        visitor.visitVarInsn(ALOAD, 3);
        visitor.visitLdcInsn("random.bow");
        visitor.visitLdcInsn(new Float("0.5"));
        visitor.visitLdcInsn(new Float("0.4"));
        visitor.visitFieldInsn(GETSTATIC, "net/minecraft/item/ItemEnderPearl", "itemRand", "Ljava/util/Random;");
        visitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Random", "nextFloat", "()F", false);
        visitor.visitLdcInsn(new Float("0.4"));
        visitor.visitInsn(FMUL);
        visitor.visitLdcInsn(new Float("0.8"));
        visitor.visitInsn(FADD);
        visitor.visitInsn(FDIV);
        visitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/world/World", "playSoundAtEntity", "(Lnet/minecraft/entity/Entity;Ljava/lang/String;FF)V", false);
        Label l2 = new Label();
        visitor.visitLabel(l2);
        visitor.visitLineNumber(15, l2);
        visitor.visitVarInsn(ALOAD, 2);
        visitor.visitFieldInsn(GETFIELD, "net/minecraft/world/World", "isRemote", "Z");
        Label l3 = new Label();
        visitor.visitJumpInsn(IFNE, l3);
        Label l4 = new Label();
        visitor.visitLabel(l4);
        visitor.visitLineNumber(16, l4);
        visitor.visitVarInsn(ALOAD, 2);
        visitor.visitTypeInsn(NEW, "net/minecraft/entity/item/EntityEnderPearl");
        visitor.visitInsn(DUP);
        visitor.visitVarInsn(ALOAD, 2);
        visitor.visitVarInsn(ALOAD, 3);
        visitor.visitMethodInsn(INVOKESPECIAL, "net/minecraft/entity/item/EntityEnderPearl", "<init>", "(Lnet/minecraft/world/World;Lnet/minecraft/entity/EntityLivingBase;)V", false);
        visitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/world/World", "spawnEntityInWorld", "(Lnet/minecraft/entity/Entity;)Z", false);
        visitor.visitInsn(POP);
        visitor.visitLabel(l3);
        visitor.visitLineNumber(19, l3);
        visitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
        visitor.visitVarInsn(ALOAD, 1);
        visitor.visitInsn(ARETURN);
        Label l5 = new Label();
        visitor.visitLabel(l5);
        visitor.visitLocalVariable("this", "Lnet/minecraft/item/ItemEnderPearl;", null, l0, l5, 0);
        visitor.visitLocalVariable("p_77659_1_", "Lnet/minecraft/item/ItemStack;", null, l0, l5, 1);
        visitor.visitLocalVariable("p_77659_2_", "Lnet/minecraft/world/World;", null, l0, l5, 2);
        visitor.visitLocalVariable("p_77659_3_", "Lnet/minecraft/entity/player/EntityPlayer;", null, l0, l5, 3);
